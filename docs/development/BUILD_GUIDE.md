...
Names below use **`1.0.0` as an example**; the repository’s **CMake package version** is **0.6.0** (see tags **v0.6.0**+) — verify filenames under `build/` after `cpack` or `make package`.
