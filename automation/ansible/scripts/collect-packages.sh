...
REMOTE_PROJECT_DIR="/opt/simple-dhcpd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-dhcpd/dist"
    remote_build_dir: "/opt/simple-dhcpd/build"
    remote_centralized_dir: "/opt/simple-dhcpd/dist/centralized/v$VERSION"
