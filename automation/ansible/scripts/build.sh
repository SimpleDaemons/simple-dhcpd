...
cat > /tmp/simple-dhcpd.service << 'EOF'
[Unit]
Description=Simple NFS Daemon
Documentation=https://github.com/blburns/simple-dhcpd
...
User=dhcpddev
Group=dhcpddev
ExecStart=/opt/simple-dhcpd/build/simple-dhcpd --config /etc/simple-dhcpd/simple-dhcpd.conf
...
ProtectHome=true
ReadWritePaths=/opt/simple-dhcpd
...
sudo cp /tmp/simple-dhcpd.service /etc/systemd/system/
...
audit_log_file = /var/log/simple-dhcpd/audit.log
...
# Set permissions
sudo chown dhcpddev:dhcpddev /etc/simple-dhcpd/simple-dhcpd.conf
sudo chmod 644 /etc/simple-dhcpd/simple-dhcpd.conf

echo "=== Build Complete ==="
echo "To start the service:"
echo "  sudo systemctl enable simple-dhcpd"
echo "  sudo systemctl start simple-dhcpd"
echo ""
echo "To check status:"
echo "  sudo systemctl status simple-dhcpd"
echo ""
echo "To view logs:"
echo "  sudo journalctl -u simple-dhcpd -f"
echo ""
echo "To test NFS:"
